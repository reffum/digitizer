...
##Pmod Header JB
set_property -dict { PACKAGE_PIN T20   } [get_ports { jb_p[0] }]; #IO_L15P_T2_DQS_34 Sch=JB1_p
set_property -dict { PACKAGE_PIN U20   } [get_ports { jb_n[0] }]; #IO_L15N_T2_DQS_34 Sch=JB1_N
...
set_property -dict { PACKAGE_PIN Y18   } [get_ports { jb_p[2] }]; #IO_L17P_T2_34 Sch=JB3_P
set_property -dict { PACKAGE_PIN Y19   } [get_ports { jb_n[2] }]; #IO_L17N_T2_34 Sch=JB3_N
set_property -dict { PACKAGE_PIN W18   } [get_ports { jb_p[3] }]; #IO_L22P_T3_34 Sch=JB4_P
set_property -dict { PACKAGE_PIN W19   } [get_ports { jb_n[3] }]; #IO_L22N_T3_34 Sch=JB4_N
